...
export const galleryImages: GalleryImage[] = [
  ...
  { src: '/images/food/lamb-chops-shishlik-lg.webp', alt: 'Grilled lamb chops shishlik', category: 'food' },
  { src: '/images/food/grilled-chicken-kebab-thigh-lg.webp', alt: 'Grilled chicken kebab with saffron rice', category: 'food' },
  { src: '/images/food/chicken-koobideh-kebab-lg.webp', alt: 'Chicken Koobideh Kebab', category: 'food' },
  { src: '/images/food/grilled-salmon-kebab-lg.webp', alt: 'Grilled salmon kebab with herbed rice', category: 'food' },
  { src: '/images/food/lamb-shank-lg.webp', alt: 'Slow cooked lamb shank', category: 'food' },
  { src: '/images/food/zereshk-polo-with-chicken-lg.webp', alt: 'Zereshk polo with chicken and bearberries', category: 'food' },
  { src: '/images/food/ghorme-sabzi-lg.webp', alt: 'Ghorme Sabzi herb stew with saffron rice', category: 'food' },
  { src: '/images/food/fesenjan-lg.webp', alt: 'Fesenjan walnut pomegranate stew', category: 'food' },
  { src: '/images/food/gheimeh-lg.webp', alt: 'Gheimeh stew with crispy potato sticks', category: 'food' },
  { src: '/images/food/mirza-ghasemi-lg.webp', alt: 'Mirza Ghasemi grilled eggplant appetizer', category: 'food' },
  { src: '/images/food/seasoned-olives-lg.webp', alt: 'Seasoned olives with pomegranate molasses', category: 'food' },
  { src: '/images/food/saffron-pistachio-cake-lg.webp', alt: 'Saffron pistachio cake', category: 'food' },
